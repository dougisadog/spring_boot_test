...
public class Demo {
	private String appkey = "586b613baed1791059000cf0";
	private String appMasterSecret = "ddnyvh25skmifhmg2jcjsf9gfdr2z6sh";
	...
	public void sendAndroidUnicast(boolean mode) throws Exception {
		AndroidUnicast unicast = new AndroidUnicast(appkey,appMasterSecret);
		// TODO Set your device token
		unicast.setDeviceToken("Ap36PRyi3NZ-ND52zWra2CXNGd5bi3KXA2WqroY6k7T-");
		...
		// TODO Set 'production_mode' to 'false' if it's a test device. 
		// For how to register a test device, please see the developer doc.
		unicast.setProductionMode(mode);
		// Set customized fields
